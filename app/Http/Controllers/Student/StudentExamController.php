...
class StudentExamController extends Controller
{
    ...
    public function show(ExamAttempt $attempt): View
    {
        ...
        return view('student.exams.show', compact('attempt', 'examContent', 'answersByQuestion'));
    }
    ...
    public function submit(Request $request, ExamAttempt $attempt): RedirectResponse
    {
        ...
        return redirect()->route('student.exams.result', $attempt)->with('status', 'exam-submitted');
    }
    ...
    public function result(ExamAttempt $attempt): View|RedirectResponse
    {
        ...
        if (
            request()->user()?->role === User::ROLE_STUDENT
